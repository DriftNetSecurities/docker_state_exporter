...
prod:
	docker buildx build --platform linux/amd64 -o type=docker -t docker-state-exporter-prod .
	docker tag docker-state-exporter-prod:latest 089757678707.dkr.ecr.us-east-1.amazonaws.com/docker-state-exporter-prod:latest
	docker push 089757678707.dkr.ecr.us-east-1.amazonaws.com/docker-state-exporter-prod:latest
